...
<div class="col-lg-6 col-md-6 col-sm-6">
  <div id="post-<?php the_ID(); ?>" <?php post_class('post-box mb-4 p-3'); ?>>
    ...
    <?php if ( get_theme_mod('taxi_booking_blog_admin_enable',true) || get_theme_mod('taxi_booking_blog_comment_enable',true) ) : ?>
      <div class="post-meta my-3">
        ...
        <?php if ( get_theme_mod('taxi_booking_blog_comment_enable',true) ) : ?>
          <span class="ml-3"><i class="far fa-comments mr-2"></i> <?php comments_number( esc_attr('0', 'taxi-booking'), esc_attr('0', 'taxi-booking'), esc_attr('%', 'taxi-booking') ); ?> <?php esc_html_e('comments','taxi-booking'); ?></span>
        <?php endif; ?>
      </div>
    <?php endif; ?>
    ...
    <p class="slider-button mt-4">
      <a href="<?php echo esc_url(get_permalink($post->ID)); ?>"><?php esc_html_e('Read More','taxi-booking'); ?></a>
    </p>
  </div>
</div>
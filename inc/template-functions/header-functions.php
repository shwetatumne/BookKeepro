...
function site_branding() {
	...
	$aria_label = $has_desktop_tagline_and_logo ? get_bloginfo( 'name' ) . ' ' . get_bloginfo( 'description' ) : get_bloginfo( 'name' );

	echo '<a class="brand' . ( in_array( 'logo', $includes, true ) && kadence()->option( 'custom_logo' ) ? ' has-logo-image' : '' ) . ( in_array( 'logo', $includes, true ) && 'no' !== kadence()->option( 'header_sticky' ) && kadence()->option( 'header_sticky_custom_logo' ) && kadence()->option( 'header_sticky_logo' ) ? ' has-sticky-logo' : '' ) . '" href="' . esc_url( apply_filters( 'kadence_logo_url', home_url( '/' ) ) ) . '" rel="home" aria-label="' . esc_attr( $aria_label ) . '">';
...
function mobile_site_branding() {
	...
	$has_mobile_tagline_and_logo = in_array( 'tagline', $includes, true ) && ( ! isset( $layouts['desktop'] ) || ( isset( $layouts['desktop'] ) && 'top_title_logo_tag' !== $layouts['desktop'] ) );

	$aria_label = $has_mobile_tagline_and_logo ? get_bloginfo( 'name' ) . ' ' . get_bloginfo( 'description' ) : get_bloginfo( 'name' );
	...
	echo '<a class="brand' . ( in_array( 'logo', $includes, true ) && kadence()->option( 'custom_logo' ) ? ' has-logo-image' : '' ) . ( in_array( 'logo', $includes, true ) && 'no' !== kadence()->option( 'mobile_header_sticky' ) && ( kadence()->option( 'header_sticky_custom_mobile_logo' ) && kadence()->option( 'header_sticky_mobile_logo' ) || kadence()->option( 'header_sticky_custom_logo' ) && kadence()->option( 'header_sticky_logo' ) ) ? ' has-sticky-logo' : '' ) . '" href="' . esc_url( apply_filters( 'kadence_logo_url', home_url( '/' ) ) ) . '" rel="home" aria-label="' . esc_attr( $aria_label ) . '">';
	foreach ( $includes as $include ) {
		switch ( $include ) {
			case 'logo':
